...
function postFb() {
  ...
  if ($(this).html() == 'Post to Facebook') {
    $('#post-to-fb-input').val('Posting to Facebook');
    $(this).html('Posting to Facebook');
  }
  else {
    $('#post-to-fb-input').val('Post to Facebook');
    $(this).html('Post to Facebook');
  }
}
$(function() {
  clearDebateForm();
